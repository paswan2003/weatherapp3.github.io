...
def getWeather():
    ...
    geolocator= Nominatim(user_agent="geoapiExpercises")
    ...
    api="https://api.openweathermap.org/data/2.8/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=21171b49944bb0240094d7dfe5cc1e85"
